...
$q=mysql_query("select * from masalah,klien,karyawan,kecamatan where masalah.id_klien=klien.id_klien and klien.id_kecamatan=kecamatan.id_kecamatan and karyawan.id_kecamatan=kecamatan.id_kecamatan and klien.id_kecamatan=$_SESSION[kec] and DATE_FORMAT(masalah.tanggal,'%Y-%m')='$tanggal' order by masalah.tanggal desc LIMIT $offset, $dataPerhalaman");
?>
...
<table class="table">
									...
									while($r=mysql_fetch_array($q)){ $no++;
				                        ...
				                        <tr>
                                            ...
                                            <td><a href="?module=aksi_masalah&id=<?php echo $r['id_masalah'];?>&ket=Terselesaikan"<button class="btn btn-primary" <?php echo $a;?>>Masalah Selesai</button></a><a href="?module=aksi_masalah&id=<?php echo $r['id_masalah'];?>&ket=Tertunda"<button class="btn btn-primary" <?php echo $b;?>>Masalah Tertunda</button></a></td>
				                        </tr>
                                    <?php } ?>
...
<ul class="pagination">
<?php
	$jumData = mysql_num_rows(mysql_query("select * from masalah,klien,karyawan,kecamatan where masalah.id_klien=klien.id_klien and klien.id_kecamatan=kecamatan.id_kecamatan and karyawan.id_kecamatan=kecamatan.id_kecamatan and klien.id_kecamatan=$_SESSION[kec] and DATE_FORMAT(masalah.tanggal,'%Y-%m')='$tanggal' order by masalah.tanggal desc"));
...
// perhitungan offset
$offset = ($nohalaman - 1) * $dataPerhalaman;
$q=mysql_query("select * from masalah,klien,karyawan,kecamatan where masalah.id_klien=klien.id_klien and klien.id_kecamatan=kecamatan.id_kecamatan and karyawan.id_kecamatan=kecamatan.id_kecamatan and klien.id_kecamatan=$_SESSION[kec] order by masalah.tanggal desc LIMIT $offset, $dataPerhalaman");
?>
<div class="table-responsive">
<table class="table">
				                    <thead>
...
<ul class="pagination">
<?php
	$jumData = mysql_num_rows(mysql_query("select * from masalah,klien,karyawan,kecamatan where masalah.id_klien=klien.id_klien and klien.id_kecamatan=kecamatan.id_kecamatan and karyawan.id_kecamatan=kecamatan.id_kecamatan and klien.id_kecamatan=$_SESSION[kec] order by masalah.tanggal desc"));
// menentukan jumlah halaman yang muncul berdasarkan jumlah semua data
$jumhalaman = ceil($jumData/$dataPerhalaman);
