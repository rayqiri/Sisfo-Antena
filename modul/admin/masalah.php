        		...
        		<div class="col-md-12">
		            ...
		            <div class="panel panel-default">
                        ...
                        <div class="form-group">
							<label class="col-sm-3 control-label">Kode Klien: </label>
							<div class="col-sm-9">
								<input type="text" id="search-box" name="nama" placeholder="Kode Klien" />
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="search-box2" name="kode" placeholder="Nama Klien" />
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-3 control-label">Permasalahan: </label>
							<div class="col-sm-9">
								<textarea name="masalah" required="required" class="form-control" col="4" rows="7"></textarea>
							</div>
						</div>
